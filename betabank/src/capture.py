...
class Capture:
    ...
    def take_pictures(self, filename="capture_", image_folder="./src/ui/test_images_1920x1080", search_aruco_dict=cv2.aruco.DICT_6X6_250, grayscale=False, captureNum=0):
    ...
    def take_video(self, filename, video_folder="./src/ui/test_videos_1920x1080", search_aruco_dict=cv2.aruco.DICT_6X6_250, grayscale=False):
